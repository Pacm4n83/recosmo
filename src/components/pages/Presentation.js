      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="team-member">
            <img class="mx-auto rounded-circle"  src='.././avatars/avatar-1.png' alt="" />
            <h4>Travis Kemkeu</h4>
        ...
        <div class="col-sm-3">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src='.././avatars/avatar-2.png' alt="" />
            <h4>Ismael Hadanama</h4>
          ...
          <div class="col-sm-3">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src='.././avatars/avatar-3.png' alt="" />
            <h4>Ismael Hadanama</h4>
            <p class="text-muted">Lead Marketer</p>
            <ul class="list-inline social-buttons">
              <li class="list-inline-item">
